...
local hexcode = "ff1230" -- to anyone reading, I would've gotten this from dad.healthColorArray with an rgb to hex script but the color and alpha completely break, so you gotta do it manually.
local composer = "ShredBoi"
local charter = "sodaquest"
local bonusnote = "Shark randomly came up with this idea and I decided to go along with it. Nikku is owned by Saruky"
