...
local hexcode = "9c1022" -- to anyone reading, I would've gotten this from dad.healthColorArray with an rgb to hex script but the color and alpha completely break, so you gotta do it manually.
local composer = "Dinebon_"
local charter = "sodaquest"
local bonusnote = "haha funny window moving go brrrrrrrrrrrrrrrrrrrrrrrrr"
