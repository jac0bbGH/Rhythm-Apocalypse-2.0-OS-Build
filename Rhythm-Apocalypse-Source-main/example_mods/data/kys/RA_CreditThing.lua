...
local hexcode = "ffffff" -- to anyone reading, I would've gotten this from dad.healthColorArray with an rgb to hex script but the color and alpha completely break, so you gotta do it manually.
local composer = "Composer"
local charter = "Charter"
local bonusnote = "Put some funny fun fact here i guess"
