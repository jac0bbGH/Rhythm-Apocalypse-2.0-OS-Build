...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Phone Breakingly BAD!', 0.2], //From 0% to 19%
		['How do you even get here', 0.4], //From 20% to 39%
		['Man get better', 0.5], //From 40% to 49%
		['Not too bad..', 0.6], //From 50% to 59%
		['Okay!', 0.69], //From 60% to 68%
		['Great', 0.7], //69%
		['OUTSTANDING', 0.8], //From 70% to 79%
		['RHYTHMIC', 0.9], //From 80% to 89%
		['APOCALYPSE', 1], //From 90% to 99%
	...
	public static var enteredGameplayChangers:Bool = false;
	...
	override public function create()
	{
		...
		ratingStuff = [
			...
			['RHYTHMIC', 0.9], //From 80% to 89%
			['APOCALYPSE', 1], //From 90% to 99%
			['APOCALYPSE', 1] //The value on this one isn't used actually, since Perfect is always "1"
		];
		...
		timeBar.createFilledBar(0xFF1B1B1B, 0xFF49FF16);
		...
		msTimeTxt = new FlxText(0, 0, 980, "", 32);
